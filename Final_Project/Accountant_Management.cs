...
namespace Final_Project
{
    public partial class Accountant_Management : Form
    {
        ...
        private void Accountant_Management_Load(object sender, EventArgs e)
        {
            ...
            conn.Open();
            String query = "Select pd_id as Mã_Sản_Phẩm, pd_name as Tên_Sản_Phẩm, pd_detail as Thông_Tin_Sản_Phẩm, pd_price as Giá_Sản_Phẩm, qty as Số_Lượng, pd_added as Ngày_Nhập from products";
            ...
            cbox_quarter.Items.Add("Qúy 1");
            cbox_quarter.Items.Add("Qúy 2");
            cbox_quarter.Items.Add("Qúy 3");
            cbox_quarter.Items.Add("Qúy 4");
            ...
            cbox_quarterShip.Items.Add("Qúy 1");
            cbox_quarterShip.Items.Add("Qúy 2");
            cbox_quarterShip.Items.Add("Qúy 3");
            cbox_quarterShip.Items.Add("Qúy 4");
            ...
            cbox_quarterDetail.Items.Add("Qúy 2");
            cbox_quarterDetail.Items.Add("Qúy 3");
            cbox_quarterDetail.Items.Add("Qúy 4");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            String query = "Select pd_id as Mã_Sản_Phẩm, pd_name as Tên_Sản_Phẩm, pd_detail as Thông_Tin_Sản_Phẩm, pd_price as Giá_Sản_Phẩm, qty as Số_Lượng, pd_added as Ngày_Nhập from products where Day(pd_added)='"+ day +"' and Month(pd_added)='"+ month +"' and Year(pd_added)='" + year +"'";
            SqlCommand cmd = new SqlCommand(query, conn);
            DataTable dt = new DataTable();
            SqlDataAdapter load_product = new SqlDataAdapter(cmd);
            dgv_LoadProduct.AllowUserToAddRows = false;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            String month = dtp_bytime.Value.Month.ToString();
            String year = dtp_bytime.Value.Year.ToString();
            String query = "Select pd_id as Mã_Sản_Phẩm, pd_name as Tên_Sản_Phẩm, pd_detail as Thông_Tin_Sản_Phẩm, pd_price as Giá_Sản_Phẩm, qty as Số_Lượng, pd_added as Ngày_Nhập from products where Month(pd_added)='" + month +"'";
            SqlCommand cmd = new SqlCommand(query, conn);
            DataTable dt = new DataTable();
            SqlDataAdapter load_product = new SqlDataAdapter(cmd);
            dgv_LoadProduct.AllowUserToAddRows = false;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            String month = dtp_bytime.Value.Month.ToString();
            String year = dtp_bytime.Value.Year.ToString();
            String query = "Select pd_id as Mã_Sản_Phẩm, pd_name as Tên_Sản_Phẩm, pd_detail as Thông_Tin_Sản_Phẩm, pd_price as Giá_Sản_Phẩm, qty as Số_Lượng, pd_added as Ngày_Nhập from products where Year(pd_added)='" + year + "'";
            SqlCommand cmd = new SqlCommand(query, conn);
            DataTable dt = new DataTable();
            SqlDataAdapter load_product = new SqlDataAdapter(cmd);
            dgv_LoadProduct.AllowUserToAddRows = false;
        ...
        {
            if ((string)cbox_quarter.SelectedItem == "Qúy 1")
            {
                quarter = 1;
            }
            else if ((string)cbox_quarter.SelectedItem == "Qúy 2")
            {
                quarter = 2;
            }
            else if ((string)cbox_quarter.SelectedItem == "Qúy 3")
            {
                quarter = 3;
            }
            else if ((string)cbox_quarter.SelectedItem == "Qúy 4")
            {
                quarter = 4;
            }
            else
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            String query = "Select pd_id as Mã_Sản_Phẩm, pd_name as Tên_Sản_Phẩm, pd_detail as Thông_Tin_Sản_Phẩm, pd_price as Giá_Sản_Phẩm, qty as Số_Lượng, pd_added as Ngày_Nhập from products where Year(pd_added)='" + year + "' and datepart(quarter, pd_added)='" + quarter +"'";
            SqlCommand cmd = new SqlCommand(query, conn);
            DataTable dt = new DataTable();
            SqlDataAdapter load_product = new SqlDataAdapter(cmd);
            dgv_LoadProduct.AllowUserToAddRows = false;
        ...
        {
            if ((string)cbox_quarterShip.SelectedItem == "Qúy 1")
            {
                quarter_ship = 1;
            }
            else if ((string)cbox_quarterShip.SelectedItem == "Qúy 2")
            {
                quarter_ship = 2;
            }
            else if ((string)cbox_quarterShip.SelectedItem == "Qúy 3")
            {
                quarter_ship = 3;
            }
            else if ((string)cbox_quarterShip.SelectedItem == "Qúy 4")
            {
                quarter_ship = 4;
            }
            else
        ...
        {
            if ((string)cbox_quarterDetail.SelectedItem == "Qúy 1")
            {
                quarter_detail = 1;
            }
            else if ((string)cbox_quarterDetail.SelectedItem == "Qúy 2")
            {
                quarter_detail = 2;
            }
            else if ((string)cbox_quarterDetail.SelectedItem == "Qúy 3")
            {
                quarter_detail = 3;
            }
            else if ((string)cbox_quarterDetail.SelectedItem == "Qúy 4")
            {
                quarter_detail = 4;
            }
            else
